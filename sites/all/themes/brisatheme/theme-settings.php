...
function brisatheme_form_system_theme_settings_alter(&$form, $form_state) {
  ...
  // Theme layout
  $form['st_container']['general_settings']['them_layout_config'] = array(
    '#type' => 'fieldset',
    '#title' => t('Layout setting'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  $form['st_container']['general_settings']['them_layout_config']['theme_layout'] = array(
    '#type' => 'select',
    '#title' => t('Layout'),
    '#default_value' => theme_get_setting('theme_layout'),
    '#options'  => array(
        'layout-wide'              => t('Wide - Default'),
